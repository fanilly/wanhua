...
function Drag(params) {
  ...
  this.beforeDelate = params.beforeDelate;
  this.delated = params.delated;
  ...
  this.fullCanvas = {
    canvas: '',
    ctx: '',
    width: document.documentElement.clientWidth * 5 || document.documentElement.clientWidth * 5,
    height: document.documentElement.clientHeight * 5 || document.documentElement.clientHeight * 5,
    id: ''
  }
...
function MoveDrag(params) {
  ...
  for (var i = 0; i < this.defaults.doms.length; i++) {
    var o = new Drag({
      ...
      beforeDelate: M.defaults.beforeDelate,
      delated: M.defaults.delated
    })
    obj.push(o)
  }
  return obj;
